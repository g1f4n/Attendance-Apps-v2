package com.juaracoding.attendanceapps.ApiService;
 ...
 */
 ...
 public interface APIInterfacesRest {
    ...
    @FormUrlEncoded
    @POST("login_ortu")
    Call<LoginOrtu> getAuthentication(@Field("username") String username, @Field("password") String password);

  @GET("siswaById")
    Call<SiswaByNis> getSiswa(@Query("nis") String nis);
